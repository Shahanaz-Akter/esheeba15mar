                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3 cursor-pointer">
                                <img src="{{ asset($client->image) }}" class="rounded-circle" width="30" height="30">
                                <div class="">
                        ...
                        <td>{{ ($client->sex) ? ucfirst($client->sex) : 'N/A' }}</td>
                        <td>{{ ($client->blood_group) ? DB::table('bloodgroups')->where('id', $client->blood_group)->value('group') : 'N/A' }}</td>
                        <td>{{ ($client->created_at)? $client->created_at : 'N/A' }}</td>
                        <td>{{ DB::table('serviceareas')->where('id', $client->service_area)->value('area') }}</td>
                        <td>{{ ($client->address) ? ucwords($client->address) : 'N/A' }}</td>
                        <td class="">
                            <!-- <a href="{{ url('/client/'.$client->id) }}"><button type="button" class="btn btn-sm btn-primary">Update</button></a> -->
                            <span class="me-2">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action=" {{ url('/custom_adding_clients') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                                ...
                                <div>
                                    <input type="date" class="form-control" name="date_of_birth" min="{{date('Y-m-d')}}">
                                </div>
                            </div>
                            ...
                            <!-- <div>{{ DB::table('serviceareas')->where('id', $client->service_area)->value('area') }}</div> -->
